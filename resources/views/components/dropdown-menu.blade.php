        ...
        background: #EFC882 !important;
           ...
           <!-- Menu Button -->
            ...
            <div id="dropdownMenu" role="menu" aria-labelledby="menuButton" hidden>
                ...
                <a href="https://www.shoppeskl.com/directory" class="menu mt-2 {{ request()->routeIs('directory') ? 'active-menu' : '' }}" role="menuitem" style="display:block; padding:12px; text-decoration:none; color:#5a3300; margin-bottom:8px; background:#e7c791cc; ">Directory <span class="{{ request()->routeIs('directory') ? 'd-none' : '' }}" style="float:right;">→</span></a>
                <a href="https://linktr.ee/shoppesfskl" class="menu mt-2 {{ request()->routeIs('linktree') ? 'active-menu' : '' }}" role="menuitem" style="display:block; padding:12px; text-decoration:none; color:#5a3300; margin-bottom:8px; background:#e7c791cc;">Linktree <span class="{{ request()->routeIs('linktree') ? 'd-none' : '' }}" style="float:right;">→</span></a>
